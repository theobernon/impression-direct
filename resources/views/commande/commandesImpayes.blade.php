    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <form method="GET" action="{{route('commande.impayes.search')}}">
            ...
            <table class="table table-striped">
                ...
                @foreach($commandes->commandes as $commande)
                    <tr>
                        ...
                        <td>
                            <x-check :value="$commande->valClient" url=""></x-check>
                        </td>
                        <td>
                        ...
                        <td>
                            <x-check :value="$commande->facturee" url=""></x-check>
                        </td>
                        <td>{{$commande->nomPdf}}</td>
                        <td>
                            <x-check :value="$commande->envoyee" url=""></x-check>
                        </td>
                    </tr>
                @endforeach
                </tbody>
